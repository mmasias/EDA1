...
A diferencia de las cajas del supermercado donde los clientes se atienden en orden de llegada (FIFO), en la cocina esto no tiene sentido: **¿un café debe esperar detrás de una ensalada?**.

El cocinero -cuando ha terminado de atender el pedido anterior- siempre selecciona el **pedido pendiente con menor tiempo de preparación** para optimizar el número de pedidos completados durante la jornada.
